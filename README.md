...
Suppose that we want to examine the `fico` score of incoming loan applications for credit card purpose. Specifically we want to examine whether the average FICO's score of those loans are less than 717.
